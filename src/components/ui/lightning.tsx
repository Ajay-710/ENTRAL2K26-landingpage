...
// Actually I need to split this into two edits or be careful with the replace_file_content tool.
// Let's do the resizeCanvas fix first, that's the critical one.
    ...
    `;
        ...
        const render = () => {
            // resizeCanvas(); // Removed for performance
