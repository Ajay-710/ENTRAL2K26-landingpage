...
const DEFAULT_WORDS = ["ENTHRAL", "2K26"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS, className }: ParticleTextEffectProps) {
    ...
    const pixelSteps = 6 // Increased resolution (lower number = more particles)
    ...
    const nextWord = (word: string, canvas: HTMLCanvasElement) => {
        ...
        // Use a font that matches the design (Orbitron if available, or Arial as fallback)
        offscreenCtx.font = "900 150px Orbitron, Arial"
        ...
        // Generate new color - specific neon colors to match theme
        // Cyan or Purple
        const isCyan = Math.random() > 0.5
        const newColor = isCyan
            ? { r: 0, g: 243, b: 255 } // Cyan #00f3ff
            : { r: 188, g: 19, b: 254 } // Purple #bc13fe
    ...
    const animate = () => {
        ...
        if (frameCountRef.current % 180 === 0) { // Faster rotation (3s)
